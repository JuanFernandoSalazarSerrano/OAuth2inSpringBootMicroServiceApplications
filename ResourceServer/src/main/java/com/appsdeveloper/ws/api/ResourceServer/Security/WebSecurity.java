...
public class WebSecurity {
    ...
    SecurityFilterChain configure(HttpSecurity http) throws Exception{
        ...
        authz
        .requestMatchers(HttpMethod.GET, "/users/status/check").hasAuthority("SCOPE_profile") // if get method is used to that endpoint this user must have a profile scope of access
